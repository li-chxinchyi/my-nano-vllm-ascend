# /usr/local/python3.11.14/lib/python3.11/site-packages/torch_npu/utils/custom_ops.py
import warnings
import torch
import torch_npu
...
torch_npu.npu_sparse_flash_attention_grad = torch.ops.npu.npu_sparse_flash_attention_grad
...
torch_npu.npu_sparse_flash_attention = torch.ops.npu.npu_sparse_flash_attention
...
torch_npu.npu_grouped_matmul_add = torch.ops.npu.npu_grouped_matmul_add
...
torch_npu.npu_mla_prolog_v3_functional = torch.ops.npu.npu_mla_prolog_v3_functional
...
torch_npu.npu_kv_quant_sparse_flash_attention = torch.ops.npu.npu_kv_quant_sparse_flash_attention
...
torch_npu.npu_grouped_matmul_swiglu_quant_v2 = torch.ops.npu.npu_grouped_matmul_swiglu_quant_v2
...
torch_npu.npu_quant_lightning_indexer = torch.ops.npu.npu_quant_lightning_indexer
...
torch_npu.npu_recurrent_gated_delta_rule = torch.ops.npu.npu_recurrent_gated_delta_rule
...
torch_npu.attention_worker_scheduler = torch.ops.npu.attention_worker_scheduler
...
torch_npu.ffn_worker_scheduler = torch.ops.npu.ffn_worker_scheduler
...
torch_npu.ffn_worker_scheduler_ = torch.ops.npu.ffn_worker_scheduler_
...
torch_npu.attention_worker_scheduler_ = torch.ops.npu.attention_worker_scheduler_
...
torch_npu.npu_lightning_indexer_grad = torch.ops.npu.npu_lightning_indexer_grad
...
torch_npu.npu_mla_prolog_v3 = torch.ops.npu.npu_mla_prolog_v3
torch_npu.npu_sparse_lightning_indexer_grad_kl_loss = torch.ops.npu.npu_sparse_lightning_indexer_grad_kl_loss
...
torch_npu.npu_clipped_swiglu = torch.ops.npu.npu_clipped_swiglu
...
torch_npu.npu_lightning_indexer = torch.ops.npu.npu_lightning_indexer
...
torch_npu.npu_sim_exponential_ = torch.ops.npu.npu_sim_exponential_
...
torch_npu.npu_recurrent_gated_delta_rule_functional = torch.ops.npu.npu_recurrent_gated_delta_rule_functional
torch_npu.npu_nsa_select_attention_infer = torch.ops.npu.npu_nsa_select_attention_infer
torch_npu.npu_gelu_mul = torch.ops.npu.npu_gelu_mul
...
torch_npu._npu_fused_infer_attention_score_v2_infer_output = torch.ops.npu._npu_fused_infer_attention_score_v2_infer_output
...
torch_npu._npu_fused_infer_attention_score_infer_output = torch.ops.npu._npu_fused_infer_attention_score_infer_output
