...
融合推理注意力与 tiling（op-plugin / ACLNN 概念整理，便于对照官方 API）：[docs/fused_infer_attention_and_tiling.md](docs/fused_infer_attention_and_tiling.md)
...
| 文档 | 描述 |
|------|------|
| [docs/fused_infer_attention_and_tiling.md](docs/fused_infer_attention_and_tiling.md) | 昇腾 `npu_fused_infer_attention_score_v2`：op-plugin 职责、ACLLN V4/V5、注意力公式与 tiling / online softmax 概念 |
