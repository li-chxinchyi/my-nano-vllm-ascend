...
/* !
* \file moe_gating_top_k_softmax_infershape.cpp
* \brief Infer shape implementation for NpuMoeGatingTopKSoftmax
*/
...
static ge::graphStatus InferShape4MoeGatingTopKSoftmax(gert::InferShapeContext *context)
{
    OP_LOGD(context, "Begin to do NpuMoeGatingTopKSoftmax Infershape.");
    ...
    OP_LOGD(context, "End to do NpuMoeGatingTopKSoftmax Infershape.");
    return ge::GRAPH_SUCCESS;
}

static ge::graphStatus InferDataType4MoeGatingTopKSoftmax(gert::InferDataTypeContext *context)
{
    OP_LOGD(context, "Begin to do NpuMoeGatingTopKSoftmax InferDataType.");
    ...
    OP_LOGD(context, "End to do NpuMoeGatingTopKSoftmax InferDataType.");
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(NpuMoeGatingTopKSoftmax).InferShape(InferShape4MoeGatingTopKSoftmax).InferDataType(InferDataType4MoeGatingTopKSoftmax);
} // namespace ops